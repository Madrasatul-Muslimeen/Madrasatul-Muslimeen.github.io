...
assert.equal(matrix.cases.length, 28);
...
assert.match(candidate, /request\.resource\.data\.keys\(\)\.hasOnly/);
...
console.log("==== Activity Rules proposal matrix: 28 cases structurally verified; executable Rules unchanged ====");
