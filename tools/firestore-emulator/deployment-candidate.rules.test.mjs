...
const PROJECT = "demo-quranrevival-activity-deploy-v1";
...
assert.ok(matchBlocks.includes("activity"), "the deployment candidate must govern activity");
assert.ok(/S8-class fix/.test(candidate), "the DEPLOYMENT candidate must BE the production rules plus the amendment");
