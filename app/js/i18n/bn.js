...
export const BN = {
  ...
  "Permanent Notes for this source": "এই উৎসের স্থায়ী নোটসমূহ",
  "Save as permanent Note": "স্থায়ী নোট হিসেবে সংরক্ষণ করুন",
  "Permanent Notes could not be checked. Creation is disabled for safety.": "স্থায়ী নোট যাচাই করা যায়নি। নিরাপত্তার জন্য তৈরি করা বন্ধ আছে।",
  "Untitled permanent Note": "শিরোনামহীন স্থায়ী নোট",
  "No permanent Notes for this source yet.": "এই উৎসের জন্য এখনো কোনো স্থায়ী নোট নেই।",
  "Save permanent Note": "স্থায়ী নোট সংরক্ষণ করুন",
  ...
  "A permanent Note already exists for this source. Create another?": "এই উৎসের জন্য একটি স্থায়ী নোট ইতিমধ্যে আছে। আরেকটি তৈরি করবেন?",
