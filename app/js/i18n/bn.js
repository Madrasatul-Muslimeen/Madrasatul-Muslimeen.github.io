...
export const BN = {
  ...
  "The number is this form's position in the list below, not the traditional Arabic verb form (I, II, III…).": "সংখ্যাটি নিচের তালিকায় এই রূপের ক্রম, প্রচলিত আরবি ক্রিয়ার বাব (I, II, III…) নয়।",
  "A grammatical category is not shown per form: the packaged data classifies each written word together with its attached particles, not the dictionary form.": "প্রতিটি রূপের ব্যাকরণগত শ্রেণি দেখানো হয়নি: সংরক্ষিত তথ্য প্রতিটি লিখিত শব্দকে তার সংযুক্ত উপসর্গ-অব্যয়সহ শ্রেণিবদ্ধ করে, অভিধানের মূল রূপ নয়।",
